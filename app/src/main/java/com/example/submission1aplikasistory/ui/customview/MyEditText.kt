package com.example.submission1aplikasistory.ui.customview
...
import com.example.submission1aplikasistory.helper.isValidEmail
...
class MyEditText : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init(attrs: AttributeSet?, defStyleAttr: Int = 0) {
        ...
        isUsername = a.getBoolean(R.styleable.MyEditText_username, false)
        enabledBackground = ContextCompat.getDrawable(context, R.drawable.bg_edt_txt) as Drawable
        ...
        passwordImage = ContextCompat.getDrawable(context, R.drawable.ic_lock) as Drawable
        usernameImage = ContextCompat.getDrawable(context, R.drawable.ic_person) as Drawable
